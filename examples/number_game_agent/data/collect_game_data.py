...
from number_game_agent.android_env import ADBController
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help="每个设备收集多少局游戏（默认10局）"
    )
    
    parser.add_argument(
        "--output-dir",
        type=str,
        default="game_data_raw",
        help="输出目录（默认 game_data_raw）"
    )
