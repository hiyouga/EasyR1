...
# https://github.com/volcengine/verl/blob/main/verl/utils/reward_score/math_dapo.py
...
def is_correct_minerva(solution_str: str, gt: str, answer_pattern: str = r"(?i)Answer\s*:\s*([^\n]+)") -> tuple[bool, str]:
...
def accuracy_reward(response: str, ground_truth: str) -> float:
    ...
    solution_str = response[-300:]  # The longest answer in MATH-500 has 159 characters
